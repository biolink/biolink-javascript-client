...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BioLinkApi.Allele();
  });
  ...
  describe('Allele', function() {
    it('should create an instance of Allele', function() {
      // uncomment below and update the code to test Allele
      //var instane = new BioLinkApi.Allele();
      //expect(instance).to.be.a(BioLinkApi.Allele);
    });
