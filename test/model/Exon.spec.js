...
(function(root, factory) {
  ...
  describe('Exon', function() {
    it('should create an instance of Exon', function() {
      // uncomment below and update the code to test Exon
      //var instane = new BioLinkApi.Exon();
      //expect(instance).to.be.a(BioLinkApi.Exon);
    });
