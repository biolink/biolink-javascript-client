...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BioLinkApi.NlpannotateApi = factory(root.BioLinkApi.ApiClient, root.BioLinkApi.Association);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<String>} opts.category E.g. phenotype
     ...
     */
    this.getAnnotate = function(text, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'text' is set
      if (text == undefined || text == null) {
        throw "Missing the required parameter 'text' when calling getAnnotate";
      }
