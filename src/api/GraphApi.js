...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BioLinkApi.GraphApi = factory(root.BioLinkApi.ApiClient, root.BioLinkApi.Graph);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getEdgeResource = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw "Missing the required parameter 'id' when calling getEdgeResource";
      }
     ...
     * data is of type: {Array.<module:model/Graph>}
     */
    this.getNodeResource = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw "Missing the required parameter 'id' when calling getNodeResource";
      }
